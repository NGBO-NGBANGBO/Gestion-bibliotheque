...
<span class="SubHead">modifier  le Livre selectionné</span>
<br />
<br />
...
<select name='genre'>
		...
		<option value='Professional'  >Psychologie</option>
...
<tr><td class="labels"> Image: </td><td><input type="file" name="photo" placeholder="enter une photo" size="25" class="fields" required="required"  /></td></tr>
 ...
 <td colspan=4> <textarea name='desc' placeholder="description ou bien résume..."  rows=10 cols=90></textarea></td></tr>
...
<br />
<br />
<a href="slcbook.php" class="link">Retour</a>
<br />
<br />
